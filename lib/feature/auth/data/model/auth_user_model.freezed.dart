...
@HiveField(1)@JsonKey(name: "id") int get id;@HiveField(2)@JsonKey(name: "name") String get name;@HiveField(3)@JsonKey(name: "email") String? get email;@HiveField(4)@JsonKey(name: "phone") String get phone;@HiveField(7)@JsonKey(name: "fcm_token") String? get fcmToken;
...
@useResult
$Res call({
@HiveField(1)@JsonKey(name: "id") int id,@HiveField(2)@JsonKey(name: "name") String name,@HiveField(3)@JsonKey(name: "email") String? email,@HiveField(4)@JsonKey(name: "phone") String phone,@HiveField(7)@JsonKey(name: "fcm_token") String? fcmToken
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(1)@JsonKey(name: "id")  int id, @HiveField(2)@JsonKey(name: "name")  String name, @HiveField(3)@JsonKey(name: "email")  String? email, @HiveField(4)@JsonKey(name: "phone")  String phone, @HiveField(7)@JsonKey(name: "fcm_token")  String? fcmToken)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthUserModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(1)@JsonKey(name: "id")  int id, @HiveField(2)@JsonKey(name: "name")  String name, @HiveField(3)@JsonKey(name: "email")  String? email, @HiveField(4)@JsonKey(name: "phone")  String phone, @HiveField(7)@JsonKey(name: "fcm_token")  String? fcmToken)  $default,) {final _that = this;
switch (_that) {
case _AuthUserModel():
return $default(_that.id,_that.name,_that.email,_that.phone,_that.fcmToken);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@HiveField(1)@JsonKey(name: "id")  int id, @HiveField(2)@JsonKey(name: "name")  String name, @HiveField(3)@JsonKey(name: "email")  String? email, @HiveField(4)@JsonKey(name: "phone")  String phone, @HiveField(7)@JsonKey(name: "fcm_token")  String? fcmToken)?  $default,) {final _that = this;
switch (_that) {
case _AuthUserModel() when $default != null:
return $default(_that.id,_that.name,_that.email,_that.phone,_that.fcmToken);case _:
  return null;
...
class _AuthUserModel implements AuthUserModel {
  const _AuthUserModel({@HiveField(1)@JsonKey(name: "id") required this.id, @HiveField(2)@JsonKey(name: "name") required this.name, @HiveField(3)@JsonKey(name: "email") this.email, @HiveField(4)@JsonKey(name: "phone") required this.phone, @HiveField(7)@JsonKey(name: "fcm_token") this.fcmToken});
...
@override@HiveField(2)@JsonKey(name: "name") final  String name;
@override@HiveField(3)@JsonKey(name: "email") final  String? email;
@override@HiveField(4)@JsonKey(name: "phone") final  String phone;
@override@HiveField(7)@JsonKey(name: "fcm_token") final  String? fcmToken;
